    ...
    public class MoveInformationUnitTests
    {
        ...
        public class ToStringMethodTests
        {
            ...
            public void BasicVerificationTests()
            {
                ...
                foreach (Tuple<CB.BoardSquare, CB.BoardSquare, bool, PieceColor, PieceClass, string> tuple in testData)
                {
                    ...
                    CB.MoveInformation testMove = new CB.MoveInformation(tuple.Item1, tuple.Item2, tuple.Item3);
        ...
        public class PropertiesTests
        {
            ...
            public void BasicPropertiesTests()
            {
                ...
                CB.MoveInformation testMove = new CB.MoveInformation(startSquare, endSquare, previouslyDeployed);
                ...
                testMove = new CB.MoveInformation(startSquare, endSquare, previouslyDeployed);
